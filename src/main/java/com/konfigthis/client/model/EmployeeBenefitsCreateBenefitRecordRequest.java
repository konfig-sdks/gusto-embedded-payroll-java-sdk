...
public class EmployeeBenefitsCreateBenefitRecordRequest {
 ...
 public enum DeductionReducesTaxableIncomeEnum {
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest() {
  }

  public EmployeeBenefitsCreateBenefitRecordRequest companyBenefitUuid(String companyBenefitUuid) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest active(Boolean active) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest employeeDeduction(String employeeDeduction) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest deductAsPercentage(Boolean deductAsPercentage) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest employeeDeductionAnnualMaximum(String employeeDeductionAnnualMaximum) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest contribution(EmployeeBenefitsCreateBenefitRecordRequestContribution contribution) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequestContribution getContribution() {
    return contribution;
  }


  public void setContribution(EmployeeBenefitsCreateBenefitRecordRequestContribution contribution) {
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest elective(Boolean elective) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest companyContributionAnnualMaximum(String companyContributionAnnualMaximum) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest limitOption(String limitOption) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest catchUp(Boolean catchUp) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest coverageAmount(String coverageAmount) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest coverageSalaryMultiplier(String coverageSalaryMultiplier) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest deductionReducesTaxableIncome(DeductionReducesTaxableIncomeEnum deductionReducesTaxableIncome) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest companyContribution(String companyContribution) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRecordRequest contributeAsPercentage(Boolean contributeAsPercentage) {
  ...
  **/
   ...
   * @return the EmployeeBenefitsCreateBenefitRecordRequest instance itself
   */
  public EmployeeBenefitsCreateBenefitRecordRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeBenefitsCreateBenefitRecordRequest employeeBenefitsCreateBenefitRecordRequest = (EmployeeBenefitsCreateBenefitRecordRequest) o;
    return Objects.equals(this.companyBenefitUuid, employeeBenefitsCreateBenefitRecordRequest.companyBenefitUuid) &&
        Objects.equals(this.active, employeeBenefitsCreateBenefitRecordRequest.active) &&
        Objects.equals(this.employeeDeduction, employeeBenefitsCreateBenefitRecordRequest.employeeDeduction) &&
        Objects.equals(this.deductAsPercentage, employeeBenefitsCreateBenefitRecordRequest.deductAsPercentage) &&
        Objects.equals(this.employeeDeductionAnnualMaximum, employeeBenefitsCreateBenefitRecordRequest.employeeDeductionAnnualMaximum) &&
        Objects.equals(this.contribution, employeeBenefitsCreateBenefitRecordRequest.contribution) &&
        Objects.equals(this.elective, employeeBenefitsCreateBenefitRecordRequest.elective) &&
        Objects.equals(this.companyContributionAnnualMaximum, employeeBenefitsCreateBenefitRecordRequest.companyContributionAnnualMaximum) &&
        Objects.equals(this.limitOption, employeeBenefitsCreateBenefitRecordRequest.limitOption) &&
        Objects.equals(this.catchUp, employeeBenefitsCreateBenefitRecordRequest.catchUp) &&
        Objects.equals(this.coverageAmount, employeeBenefitsCreateBenefitRecordRequest.coverageAmount) &&
        Objects.equals(this.coverageSalaryMultiplier, employeeBenefitsCreateBenefitRecordRequest.coverageSalaryMultiplier) &&
        Objects.equals(this.deductionReducesTaxableIncome, employeeBenefitsCreateBenefitRecordRequest.deductionReducesTaxableIncome) &&
        Objects.equals(this.companyContribution, employeeBenefitsCreateBenefitRecordRequest.companyContribution) &&
        Objects.equals(this.contributeAsPercentage, employeeBenefitsCreateBenefitRecordRequest.contributeAsPercentage)&&
        Objects.equals(this.additionalProperties, employeeBenefitsCreateBenefitRecordRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeBenefitsCreateBenefitRecordRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeBenefitsCreateBenefitRecordRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeBenefitsCreateBenefitRecordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeBenefitsCreateBenefitRecordRequest is not found in the empty JSON string", EmployeeBenefitsCreateBenefitRecordRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeBenefitsCreateBenefitRecordRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("contribution") != null && !jsonObj.get("contribution").isJsonNull()) {
        EmployeeBenefitsCreateBenefitRecordRequestContribution.validateJsonObject(jsonObj.getAsJsonObject("contribution"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeBenefitsCreateBenefitRecordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeBenefitsCreateBenefitRecordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeBenefitsCreateBenefitRecordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeBenefitsCreateBenefitRecordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeBenefitsCreateBenefitRecordRequest>() {
           @Override
           public void write(JsonWriter out, EmployeeBenefitsCreateBenefitRecordRequest value) throws IOException {
           ...
           @Override
           public EmployeeBenefitsCreateBenefitRecordRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeBenefitsCreateBenefitRecordRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeBenefitsCreateBenefitRecordRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeBenefitsCreateBenefitRecordRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeeBenefitsCreateBenefitRecordRequest
  */
  public static EmployeeBenefitsCreateBenefitRecordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeBenefitsCreateBenefitRecordRequest.class);
  }

 /**
  * Convert an instance of EmployeeBenefitsCreateBenefitRecordRequest to an JSON string
  *
  * @return JSON string
  */
