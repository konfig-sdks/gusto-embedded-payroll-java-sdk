...
import com.konfigthis.client.model.PayrollEmployeeCompensationsTypeInner;
import com.konfigthis.client.model.PayrollFixedCompensationTypesTypeInner;
...
public class PayrollPrepared {
  ...
  private List<PayrollEmployeeCompensationsTypeInner> employeeCompensations = null;
  ...
  public static final String SERIALIZED_NAME_FIXED_COMPENSATION_TYPES = "fixed_compensation_types";
  @SerializedName(SERIALIZED_NAME_FIXED_COMPENSATION_TYPES)
  private List<PayrollFixedCompensationTypesTypeInner> fixedCompensationTypes = null;
  ...
  **/
  ...
  public PayrollPrepared offCycleReason(OffCycleReasonType offCycleReason) {
  ...
  **/
  ...
  public PayrollPrepared withholdingPayPeriod(PayrollWithholdingPayPeriodType withholdingPayPeriod) {
  ...
  **/
  ...
  public PayrollPrepared payPeriod(PayrollPayPeriodType payPeriod) {
  ...
  **/
  ...
  public PayrollPrepared payrollStatusMeta(PayrollPayrollStatusMetaType payrollStatusMeta) {
  ...
  **/
  ...
  public PayrollPrepared employeeCompensations(List<PayrollEmployeeCompensationsTypeInner> employeeCompensations) {
  ...
  public PayrollPrepared addEmployeeCompensationsItem(PayrollEmployeeCompensationsTypeInner employeeCompensationsItem) {
  ...
  **/
  ...
  public List<PayrollEmployeeCompensationsTypeInner> getEmployeeCompensations() {
    return employeeCompensations;
  }


  public void setEmployeeCompensations(List<PayrollEmployeeCompensationsTypeInner> employeeCompensations) {
  ...
  public PayrollPrepared paymentSpeedChanged(PayrollPaymentSpeedChangedType paymentSpeedChanged) {
  ...
  **/
  ...
  public PayrollPrepared fixedCompensationTypes(List<PayrollFixedCompensationTypesTypeInner> fixedCompensationTypes) {
  ...
  public PayrollPrepared addFixedCompensationTypesItem(PayrollFixedCompensationTypesTypeInner fixedCompensationTypesItem) {
    if (this.fixedCompensationTypes == null) {
      this.fixedCompensationTypes = new ArrayList<>();
    }
    this.fixedCompensationTypes.add(fixedCompensationTypesItem);
    return this;
  }

   /**
   * Get fixedCompensationTypes
   * @return fixedCompensationTypes
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<PayrollFixedCompensationTypesTypeInner> getFixedCompensationTypes() {
    return fixedCompensationTypes;
  }


  public void setFixedCompensationTypes(List<PayrollFixedCompensationTypesTypeInner> fixedCompensationTypes) {
   ...
   * @return the PayrollPrepared instance itself
   */
  public PayrollPrepared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayrollPrepared payrollPrepared = (PayrollPrepared) o;
    return Objects.equals(this.payrollDeadline, payrollPrepared.payrollDeadline) &&
        Objects.equals(this.checkDate, payrollPrepared.checkDate) &&
        Objects.equals(this.processed, payrollPrepared.processed) &&
        Objects.equals(this.processedDate, payrollPrepared.processedDate) &&
        Objects.equals(this.calculatedAt, payrollPrepared.calculatedAt) &&
        Objects.equals(this.payrollUuid, payrollPrepared.payrollUuid) &&
        Objects.equals(this.companyUuid, payrollPrepared.companyUuid) &&
        Objects.equals(this.offCycle, payrollPrepared.offCycle) &&
        Objects.equals(this.offCycleReason, payrollPrepared.offCycleReason) &&
        Objects.equals(this.external, payrollPrepared.external) &&
        Objects.equals(this.finalTerminationPayroll, payrollPrepared.finalTerminationPayroll) &&
        Objects.equals(this.withholdingPayPeriod, payrollPrepared.withholdingPayPeriod) &&
        Objects.equals(this.skipRegularDeductions, payrollPrepared.skipRegularDeductions) &&
        Objects.equals(this.fixedWithholdingRate, payrollPrepared.fixedWithholdingRate) &&
        Objects.equals(this.payPeriod, payrollPrepared.payPeriod) &&
        Objects.equals(this.payrollStatusMeta, payrollPrepared.payrollStatusMeta) &&
        Objects.equals(this.employeeCompensations, payrollPrepared.employeeCompensations) &&
        Objects.equals(this.paymentSpeedChanged, payrollPrepared.paymentSpeedChanged) &&
        Objects.equals(this.createdAt, payrollPrepared.createdAt) &&
        Objects.equals(this.fixedCompensationTypes, payrollPrepared.fixedCompensationTypes)&&
        Objects.equals(this.additionalProperties, payrollPrepared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayrollPrepared {\n");
    ...
    sb.append("    fixedCompensationTypes: ").append(toIndentedString(fixedCompensationTypes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fixed_compensation_types");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayrollPrepared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayrollPrepared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayrollPrepared is not found in the empty JSON string", PayrollPrepared.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("employee_compensations") != null && !jsonObj.get("employee_compensations").isJsonNull()) {
        ...
        if (jsonArrayemployeeCompensations != null) {
          ...
          for (int i = 0; i < jsonArrayemployeeCompensations.size(); i++) {
            PayrollEmployeeCompensationsTypeInner.validateJsonObject(jsonArrayemployeeCompensations.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("fixed_compensation_types") != null && !jsonObj.get("fixed_compensation_types").isJsonNull()) {
        JsonArray jsonArrayfixedCompensationTypes = jsonObj.getAsJsonArray("fixed_compensation_types");
        if (jsonArrayfixedCompensationTypes != null) {
          // ensure the json data is an array
          if (!jsonObj.get("fixed_compensation_types").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `fixed_compensation_types` to be an array in the JSON string but got `%s`", jsonObj.get("fixed_compensation_types").toString()));
          }

          // validate the optional field `fixed_compensation_types` (array)
          for (int i = 0; i < jsonArrayfixedCompensationTypes.size(); i++) {
            PayrollFixedCompensationTypesTypeInner.validateJsonObject(jsonArrayfixedCompensationTypes.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayrollPrepared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayrollPrepared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayrollPrepared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayrollPrepared.class));

       return (TypeAdapter<T>) new TypeAdapter<PayrollPrepared>() {
           @Override
           public void write(JsonWriter out, PayrollPrepared value) throws IOException {
           ...
           @Override
           public PayrollPrepared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayrollPrepared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayrollPrepared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayrollPrepared
  * @throws IOException if the JSON string is invalid with respect to PayrollPrepared
  */
  public static PayrollPrepared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayrollPrepared.class);
  }

 /**
  * Convert an instance of PayrollPrepared to an JSON string
  *
  * @return JSON string
  */
