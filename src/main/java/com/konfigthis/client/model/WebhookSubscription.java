 ...
 */
@ApiModel(description = "The representation of webhook subscription.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebhookSubscription {
  ...
  **/
  ...
  @ApiModelProperty(example = "c5fdae57-5483-4529-9aae-f0edceed92d4", value = "The UUID of the webhook subscription.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://partner-app.com/subscriber", value = "The webhook subscriber URL. Updates will be POSTed to this URL.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "VERIFIED", value = "The status of the webhook subscription.")
  ...
  public WebhookSubscription subscriptionTypes(List<SubscriptionTypesEnum> subscriptionTypes) {
  ...
  public WebhookSubscription addSubscriptionTypesItem(SubscriptionTypesEnum subscriptionTypesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Receive updates for these types.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, webhookSubscription.uuid) &&
        ...
        Objects.equals(this.subscriptionTypes, webhookSubscription.subscriptionTypes)&&
        Objects.equals(this.additionalProperties, webhookSubscription.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, url, status, subscriptionTypes, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("subscription_types") != null && !jsonObj.get("subscription_types").isJsonArray()) {
