...
import com.konfigthis.client.model.PayrollCompanyTaxesTypeInner;
...
public class Payroll {
  ...
  public static final String SERIALIZED_NAME_COMPANY_TAXES = "company_taxes";
  @SerializedName(SERIALIZED_NAME_COMPANY_TAXES)
  private List<PayrollCompanyTaxesTypeInner> companyTaxes = null;
  ...
  **/
  ...
  public Payroll offCycleReason(OffCycleReasonType offCycleReason) {
  ...
  **/
  ...
  public Payroll withholdingPayPeriod(PayrollWithholdingPayPeriodType withholdingPayPeriod) {
  ...
  **/
  ...
  public Payroll payPeriod(PayrollPayPeriodType payPeriod) {
  ...
  **/
  ...
  public Payroll payrollStatusMeta(PayrollPayrollStatusMetaType payrollStatusMeta) {
  ...
  **/
  ...
  public Payroll totals(PayrollTotalsType totals) {
  ...
  **/
  ...
  public Payroll employeeCompensations(List<PayrollEmployeeCompensationsTypeInner> employeeCompensations) {
  ...
  public Payroll addEmployeeCompensationsItem(PayrollEmployeeCompensationsTypeInner employeeCompensationsItem) {
  ...
  **/
  ...
  public Payroll companyTaxes(List<PayrollCompanyTaxesTypeInner> companyTaxes) {
  ...
  public Payroll addCompanyTaxesItem(PayrollCompanyTaxesTypeInner companyTaxesItem) {
    if (this.companyTaxes == null) {
      this.companyTaxes = new ArrayList<>();
    }
    this.companyTaxes.add(companyTaxesItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of taxes applicable to this payroll in addition to taxes included in `employee_compensations`. Only included for processed or calculated payrolls when `taxes` is present in the `include` parameter.")

  public List<PayrollCompanyTaxesTypeInner> getCompanyTaxes() {
    return companyTaxes;
  }


  public void setCompanyTaxes(List<PayrollCompanyTaxesTypeInner> companyTaxes) {
  ...
  public Payroll paymentSpeedChanged(PayrollPaymentSpeedChangedType paymentSpeedChanged) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payrollDeadline, payroll.payrollDeadline) &&
        Objects.equals(this.checkDate, payroll.checkDate) &&
        Objects.equals(this.processed, payroll.processed) &&
        Objects.equals(this.processedDate, payroll.processedDate) &&
        Objects.equals(this.calculatedAt, payroll.calculatedAt) &&
        Objects.equals(this.payrollUuid, payroll.payrollUuid) &&
        Objects.equals(this.companyUuid, payroll.companyUuid) &&
        Objects.equals(this.offCycle, payroll.offCycle) &&
        Objects.equals(this.offCycleReason, payroll.offCycleReason) &&
        Objects.equals(this.external, payroll.external) &&
        Objects.equals(this.finalTerminationPayroll, payroll.finalTerminationPayroll) &&
        Objects.equals(this.withholdingPayPeriod, payroll.withholdingPayPeriod) &&
        Objects.equals(this.skipRegularDeductions, payroll.skipRegularDeductions) &&
        Objects.equals(this.fixedWithholdingRate, payroll.fixedWithholdingRate) &&
        Objects.equals(this.payPeriod, payroll.payPeriod) &&
        Objects.equals(this.payrollStatusMeta, payroll.payrollStatusMeta) &&
        Objects.equals(this.totals, payroll.totals) &&
        Objects.equals(this.employeeCompensations, payroll.employeeCompensations) &&
        Objects.equals(this.companyTaxes, payroll.companyTaxes) &&
        Objects.equals(this.paymentSpeedChanged, payroll.paymentSpeedChanged) &&
        Objects.equals(this.createdAt, payroll.createdAt)&&
  ...
  public String toString() {
    ...
    sb.append("    companyTaxes: ").append(toIndentedString(companyTaxes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("company_taxes");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("company_taxes") != null && !jsonObj.get("company_taxes").isJsonNull()) {
        JsonArray jsonArraycompanyTaxes = jsonObj.getAsJsonArray("company_taxes");
        if (jsonArraycompanyTaxes != null) {
          // ensure the json data is an array
          if (!jsonObj.get("company_taxes").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `company_taxes` to be an array in the JSON string but got `%s`", jsonObj.get("company_taxes").toString()));
          }

          // validate the optional field `company_taxes` (array)
          for (int i = 0; i < jsonArraycompanyTaxes.size(); i++) {
            PayrollCompanyTaxesTypeInner.validateJsonObject(jsonArraycompanyTaxes.get(i).getAsJsonObject());
          };
        }
      }
