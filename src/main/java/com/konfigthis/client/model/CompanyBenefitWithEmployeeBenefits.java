...
public class CompanyBenefitWithEmployeeBenefits {
  ...
  public static final String SERIALIZED_NAME_EMPLOYEE_BENEFITS = "employee_benefits";
  @SerializedName(SERIALIZED_NAME_EMPLOYEE_BENEFITS)
  private List<CompanyBenefitWithEmployeeBenefitsEmployeeBenefitsInner> employeeBenefits = null;
  ...
  public CompanyBenefitWithEmployeeBenefits description(String description) {
  ...
  **/
  ...
  public CompanyBenefitWithEmployeeBenefits version(String version) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The type of the benefit to which the company benefit belongs (same as benefit_id).")
  ...
  public CompanyBenefitWithEmployeeBenefits active(Boolean active) {
  ...
  **/
  ...
  public CompanyBenefitWithEmployeeBenefits deletable(Boolean deletable) {
  ...
  **/
  ...
  public CompanyBenefitWithEmployeeBenefits responsibleForEmployerTaxes(Boolean responsibleForEmployerTaxes) {
  ...
  **/
  ...
  public CompanyBenefitWithEmployeeBenefits responsibleForEmployeeW2(Boolean responsibleForEmployeeW2) {
  ...
  **/
  ...
  public CompanyBenefitWithEmployeeBenefits employeeBenefits(List<CompanyBenefitWithEmployeeBenefitsEmployeeBenefitsInner> employeeBenefits) {
  ...
  public CompanyBenefitWithEmployeeBenefits addEmployeeBenefitsItem(CompanyBenefitWithEmployeeBenefitsEmployeeBenefitsInner employeeBenefitsItem) {
  ...
  **/
  ...
  public List<CompanyBenefitWithEmployeeBenefitsEmployeeBenefitsInner> getEmployeeBenefits() {
    return employeeBenefits;
  }


  public void setEmployeeBenefits(List<CompanyBenefitWithEmployeeBenefitsEmployeeBenefitsInner> employeeBenefits) {
   ...
   * @return the CompanyBenefitWithEmployeeBenefits instance itself
   */
  public CompanyBenefitWithEmployeeBenefits putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyBenefitWithEmployeeBenefits companyBenefitWithEmployeeBenefits = (CompanyBenefitWithEmployeeBenefits) o;
    return Objects.equals(this.description, companyBenefitWithEmployeeBenefits.description) &&
        Objects.equals(this.version, companyBenefitWithEmployeeBenefits.version) &&
        Objects.equals(this.uuid, companyBenefitWithEmployeeBenefits.uuid) &&
        Objects.equals(this.benefitType, companyBenefitWithEmployeeBenefits.benefitType) &&
        Objects.equals(this.active, companyBenefitWithEmployeeBenefits.active) &&
        Objects.equals(this.deletable, companyBenefitWithEmployeeBenefits.deletable) &&
        Objects.equals(this.supportsPercentageAmounts, companyBenefitWithEmployeeBenefits.supportsPercentageAmounts) &&
        Objects.equals(this.responsibleForEmployerTaxes, companyBenefitWithEmployeeBenefits.responsibleForEmployerTaxes) &&
        Objects.equals(this.responsibleForEmployeeW2, companyBenefitWithEmployeeBenefits.responsibleForEmployeeW2) &&
        Objects.equals(this.employeeBenefits, companyBenefitWithEmployeeBenefits.employeeBenefits)&&
        Objects.equals(this.additionalProperties, companyBenefitWithEmployeeBenefits.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, version, uuid, benefitType, active, deletable, supportsPercentageAmounts, responsibleForEmployerTaxes, responsibleForEmployeeW2, employeeBenefits, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompanyBenefitWithEmployeeBenefits {\n");
  ...
  static {
    ...
    openapiFields.add("employee_benefits");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompanyBenefitWithEmployeeBenefits
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompanyBenefitWithEmployeeBenefits.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyBenefitWithEmployeeBenefits is not found in the empty JSON string", CompanyBenefitWithEmployeeBenefits.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("employee_benefits") != null && !jsonObj.get("employee_benefits").isJsonNull()) {
        JsonArray jsonArrayemployeeBenefits = jsonObj.getAsJsonArray("employee_benefits");
        if (jsonArrayemployeeBenefits != null) {
          // ensure the json data is an array
          if (!jsonObj.get("employee_benefits").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `employee_benefits` to be an array in the JSON string but got `%s`", jsonObj.get("employee_benefits").toString()));
          }

          // validate the optional field `employee_benefits` (array)
          for (int i = 0; i < jsonArrayemployeeBenefits.size(); i++) {
            CompanyBenefitWithEmployeeBenefitsEmployeeBenefitsInner.validateJsonObject(jsonArrayemployeeBenefits.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyBenefitWithEmployeeBenefits.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyBenefitWithEmployeeBenefits' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyBenefitWithEmployeeBenefits> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyBenefitWithEmployeeBenefits.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyBenefitWithEmployeeBenefits>() {
           @Override
           public void write(JsonWriter out, CompanyBenefitWithEmployeeBenefits value) throws IOException {
           ...
           @Override
           public CompanyBenefitWithEmployeeBenefits read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompanyBenefitWithEmployeeBenefits instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompanyBenefitWithEmployeeBenefits given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompanyBenefitWithEmployeeBenefits
  * @throws IOException if the JSON string is invalid with respect to CompanyBenefitWithEmployeeBenefits
  */
  public static CompanyBenefitWithEmployeeBenefits fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyBenefitWithEmployeeBenefits.class);
  }

 /**
  * Convert an instance of CompanyBenefitWithEmployeeBenefits to an JSON string
  *
  * @return JSON string
  */
