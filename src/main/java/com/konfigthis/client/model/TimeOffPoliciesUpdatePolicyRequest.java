...
public class TimeOffPoliciesUpdatePolicyRequest {
 ...
 public enum AccrualMethodEnum {
  ...
  public TimeOffPoliciesUpdatePolicyRequest() {
  }

  public TimeOffPoliciesUpdatePolicyRequest name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "test policy3", value = "Name of the time off policy")
  ...
  public TimeOffPoliciesUpdatePolicyRequest accrualMethod(AccrualMethodEnum accrualMethod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PER_CALENDAR_YEAR", value = "Accrual method of the time off policy")
  ...
  public TimeOffPoliciesUpdatePolicyRequest accrualRate(Float accrualRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "120.0", value = "The rate at which the time off hours will accrue for an employee on the policy. Represented as a float, e.g. \"40.0\".")
  ...
  public TimeOffPoliciesUpdatePolicyRequest accrualRateUnit(Float accrualRateUnit) {
  ...
  **/
  ...
  public TimeOffPoliciesUpdatePolicyRequest paidOutOnTermination(Boolean paidOutOnTermination) {
  ...
  **/
  ...
  public TimeOffPoliciesUpdatePolicyRequest accrualWaitingPeriodDays(Integer accrualWaitingPeriodDays) {
  ...
  **/
  ...
  public TimeOffPoliciesUpdatePolicyRequest carryoverLimitHours(Float carryoverLimitHours) {
  ...
  **/
  ...
  public TimeOffPoliciesUpdatePolicyRequest maxAccrualHoursPerYear(Float maxAccrualHoursPerYear) {
  ...
  **/
  ...
  public TimeOffPoliciesUpdatePolicyRequest maxHours(Float maxHours) {
  ...
  **/
   ...
   * @return the TimeOffPoliciesUpdatePolicyRequest instance itself
   */
  public TimeOffPoliciesUpdatePolicyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimeOffPoliciesUpdatePolicyRequest timeOffPoliciesUpdatePolicyRequest = (TimeOffPoliciesUpdatePolicyRequest) o;
    return Objects.equals(this.name, timeOffPoliciesUpdatePolicyRequest.name) &&
        Objects.equals(this.accrualMethod, timeOffPoliciesUpdatePolicyRequest.accrualMethod) &&
        Objects.equals(this.accrualRate, timeOffPoliciesUpdatePolicyRequest.accrualRate) &&
        Objects.equals(this.accrualRateUnit, timeOffPoliciesUpdatePolicyRequest.accrualRateUnit) &&
        Objects.equals(this.paidOutOnTermination, timeOffPoliciesUpdatePolicyRequest.paidOutOnTermination) &&
        Objects.equals(this.accrualWaitingPeriodDays, timeOffPoliciesUpdatePolicyRequest.accrualWaitingPeriodDays) &&
        Objects.equals(this.carryoverLimitHours, timeOffPoliciesUpdatePolicyRequest.carryoverLimitHours) &&
        Objects.equals(this.maxAccrualHoursPerYear, timeOffPoliciesUpdatePolicyRequest.maxAccrualHoursPerYear) &&
        Objects.equals(this.maxHours, timeOffPoliciesUpdatePolicyRequest.maxHours)&&
        Objects.equals(this.additionalProperties, timeOffPoliciesUpdatePolicyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, accrualMethod, accrualRate, accrualRateUnit, paidOutOnTermination, accrualWaitingPeriodDays, carryoverLimitHours, maxAccrualHoursPerYear, maxHours, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimeOffPoliciesUpdatePolicyRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimeOffPoliciesUpdatePolicyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimeOffPoliciesUpdatePolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeOffPoliciesUpdatePolicyRequest is not found in the empty JSON string", TimeOffPoliciesUpdatePolicyRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeOffPoliciesUpdatePolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeOffPoliciesUpdatePolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeOffPoliciesUpdatePolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeOffPoliciesUpdatePolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeOffPoliciesUpdatePolicyRequest>() {
           @Override
           public void write(JsonWriter out, TimeOffPoliciesUpdatePolicyRequest value) throws IOException {
           ...
           @Override
           public TimeOffPoliciesUpdatePolicyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimeOffPoliciesUpdatePolicyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimeOffPoliciesUpdatePolicyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimeOffPoliciesUpdatePolicyRequest
  * @throws IOException if the JSON string is invalid with respect to TimeOffPoliciesUpdatePolicyRequest
  */
  public static TimeOffPoliciesUpdatePolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeOffPoliciesUpdatePolicyRequest.class);
  }

 /**
  * Convert an instance of TimeOffPoliciesUpdatePolicyRequest to an JSON string
  *
  * @return JSON string
  */
