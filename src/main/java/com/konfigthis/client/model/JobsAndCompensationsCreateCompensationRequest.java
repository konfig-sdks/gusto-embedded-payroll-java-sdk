...
public class JobsAndCompensationsCreateCompensationRequest {
 ...
 public enum PaymentUnitEnum {
  ...
  public JobsAndCompensationsCreateCompensationRequest() {
  }

  public JobsAndCompensationsCreateCompensationRequest rate(String rate) {
  ...
  **/
  ...
  public JobsAndCompensationsCreateCompensationRequest paymentUnit(PaymentUnitEnum paymentUnit) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The unit accompanying the compensation rate. If the employee is an owner, rate should be 'Paycheck'.")
  ...
  public JobsAndCompensationsCreateCompensationRequest effectiveDate(String effectiveDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the compensation takes effect.")
  ...
  public JobsAndCompensationsCreateCompensationRequest flsaStatus(FlsaStatusType flsaStatus) {
  ...
  **/
  ...
  public JobsAndCompensationsCreateCompensationRequest adjustForMinimumWage(Boolean adjustForMinimumWage) {
  ...
  **/
  ...
  public JobsAndCompensationsCreateCompensationRequest minimumWages(List<JobsAndCompensationsCreateCompensationRequestMinimumWagesInner> minimumWages) {
  ...
  public JobsAndCompensationsCreateCompensationRequest addMinimumWagesItem(JobsAndCompensationsCreateCompensationRequestMinimumWagesInner minimumWagesItem) {
  ...
  **/
   ...
   * @return the JobsAndCompensationsCreateCompensationRequest instance itself
   */
  public JobsAndCompensationsCreateCompensationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JobsAndCompensationsCreateCompensationRequest jobsAndCompensationsCreateCompensationRequest = (JobsAndCompensationsCreateCompensationRequest) o;
    return Objects.equals(this.rate, jobsAndCompensationsCreateCompensationRequest.rate) &&
        Objects.equals(this.paymentUnit, jobsAndCompensationsCreateCompensationRequest.paymentUnit) &&
        Objects.equals(this.effectiveDate, jobsAndCompensationsCreateCompensationRequest.effectiveDate) &&
        Objects.equals(this.flsaStatus, jobsAndCompensationsCreateCompensationRequest.flsaStatus) &&
        Objects.equals(this.adjustForMinimumWage, jobsAndCompensationsCreateCompensationRequest.adjustForMinimumWage) &&
        Objects.equals(this.minimumWages, jobsAndCompensationsCreateCompensationRequest.minimumWages)&&
        Objects.equals(this.additionalProperties, jobsAndCompensationsCreateCompensationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rate, paymentUnit, effectiveDate, flsaStatus, adjustForMinimumWage, minimumWages, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JobsAndCompensationsCreateCompensationRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("payment_unit");
    openapiRequiredFields.add("flsa_status");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobsAndCompensationsCreateCompensationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobsAndCompensationsCreateCompensationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobsAndCompensationsCreateCompensationRequest is not found in the empty JSON string", JobsAndCompensationsCreateCompensationRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JobsAndCompensationsCreateCompensationRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("payment_unit").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobsAndCompensationsCreateCompensationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobsAndCompensationsCreateCompensationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobsAndCompensationsCreateCompensationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobsAndCompensationsCreateCompensationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<JobsAndCompensationsCreateCompensationRequest>() {
           @Override
           public void write(JsonWriter out, JobsAndCompensationsCreateCompensationRequest value) throws IOException {
           ...
           @Override
           public JobsAndCompensationsCreateCompensationRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JobsAndCompensationsCreateCompensationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JobsAndCompensationsCreateCompensationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JobsAndCompensationsCreateCompensationRequest
  * @throws IOException if the JSON string is invalid with respect to JobsAndCompensationsCreateCompensationRequest
  */
  public static JobsAndCompensationsCreateCompensationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobsAndCompensationsCreateCompensationRequest.class);
  }

 /**
  * Convert an instance of JobsAndCompensationsCreateCompensationRequest to an JSON string
  *
  * @return JSON string
  */
