...
public class PayrollReceiptTotals {
  ...
  public PayrollReceiptTotals companyDebit(String companyDebit) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1080.47", value = "The total company debit for the payroll.")
  ...
  public void setCompanyDebit(String companyDebit) {
  ...
  public PayrollReceiptTotals netPayDebit(String netPayDebit) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "748.34", value = "The total company net pay for the payroll.")
  ...
  public PayrollReceiptTotals childSupportDebit(String childSupportDebit) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.0", value = "The total child support debit for the payroll.")
  ...
  public void setChildSupportDebit(String childSupportDebit) {
  ...
  public PayrollReceiptTotals reimbursementDebit(String reimbursementDebit) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "50.0", value = "The total reimbursements for the payroll.")
  ...
  public void setReimbursementDebit(String reimbursementDebit) {
  ...
  public PayrollReceiptTotals taxDebit(String taxDebit) {
  ...
  **/
  ...
  public void setTaxDebit(String taxDebit) {
   ...
   * @return the PayrollReceiptTotals instance itself
   */
  public PayrollReceiptTotals putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayrollReceiptTotals payrollReceiptTotals = (PayrollReceiptTotals) o;
    return Objects.equals(this.companyDebit, payrollReceiptTotals.companyDebit) &&
        Objects.equals(this.netPayDebit, payrollReceiptTotals.netPayDebit) &&
        Objects.equals(this.childSupportDebit, payrollReceiptTotals.childSupportDebit) &&
        Objects.equals(this.reimbursementDebit, payrollReceiptTotals.reimbursementDebit) &&
        Objects.equals(this.taxDebit, payrollReceiptTotals.taxDebit)&&
        Objects.equals(this.additionalProperties, payrollReceiptTotals.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(companyDebit, netPayDebit, childSupportDebit, reimbursementDebit, taxDebit, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayrollReceiptTotals {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayrollReceiptTotals
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayrollReceiptTotals.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayrollReceiptTotals is not found in the empty JSON string", PayrollReceiptTotals.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayrollReceiptTotals.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayrollReceiptTotals' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayrollReceiptTotals> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayrollReceiptTotals.class));

       return (TypeAdapter<T>) new TypeAdapter<PayrollReceiptTotals>() {
           @Override
           public void write(JsonWriter out, PayrollReceiptTotals value) throws IOException {
           ...
           @Override
           public PayrollReceiptTotals read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayrollReceiptTotals instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayrollReceiptTotals given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayrollReceiptTotals
  * @throws IOException if the JSON string is invalid with respect to PayrollReceiptTotals
  */
  public static PayrollReceiptTotals fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayrollReceiptTotals.class);
  }

 /**
  * Convert an instance of PayrollReceiptTotals to an JSON string
  *
  * @return JSON string
  */
