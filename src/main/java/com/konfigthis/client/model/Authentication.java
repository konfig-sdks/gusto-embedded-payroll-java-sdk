...
public class Authentication {
  ...
  private Double expiresIn = 7200d;
  ...
  **/
  ...
  @ApiModelProperty(value = "A new access token that can be used for subsequent authenticated requests")
  ...
  public Authentication tokenType(String tokenType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "bearer", value = "The literal string 'bearer'")
  ...
  public Authentication expiresIn(Double expiresIn) {
  ...
  public Authentication expiresIn(Integer expiresIn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7200", value = "The TTL of this token. After this amount of time, you must hit the refresh token endpoint to continue making authenticated requests.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A token that must be passed to the refresh token endpoint to get a new authenticated token.")
  ...
  public Authentication createdAt(String createdAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Datetime for when the new access token is created.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "All of the scopes for which the access token provides access.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, authentication.accessToken) &&
        Objects.equals(this.tokenType, authentication.tokenType) &&
        Objects.equals(this.expiresIn, authentication.expiresIn) &&
        Objects.equals(this.refreshToken, authentication.refreshToken) &&
        Objects.equals(this.createdAt, authentication.createdAt) &&
        Objects.equals(this.scope, authentication.scope)&&
        Objects.equals(this.additionalProperties, authentication.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, tokenType, expiresIn, refreshToken, createdAt, scope, additionalProperties);
  }
